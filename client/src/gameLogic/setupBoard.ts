...
type SVGSelection = d3.Selection<SVGSVGElement, unknown, HTMLElement, undefined>;
...
const homes = [] as any[]
const cellsMap = {} as Record<string, any>
...
const drawHomes = (svg: SVGSelection) => {
    homes.push(svg
      .append("rect")
      .attr("class", 'home')
      .attr("player", 'green')
...
const stylizeHomes = (svg: SVGSelection) => {
...
const drawFinish = (svg: SVGSelection) => {
    // green
    svg
        .append('polygon')
...
const drawGullies = (svg: SVGSelection) => {
    let cellTrack = 1;
    // left
...
const drawFinalStretches = (svg: SVGSelection) => {
    let cellTrack = 1;
    // green
    cellTrack = 1;
