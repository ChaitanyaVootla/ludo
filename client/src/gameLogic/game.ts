...
import { Pawn, Player } from '@/gameLogic/player'
import { resetDice } from '@/gameLogic/dice'
import { wait } from '@/gameLogic/utils'
import { cellsMap } from '@/gameLogic/setupBoard'
...
class Game {
    ...
    setCurrentPlayer(player: Player) {
        ...
        this.askToPlayTurn()
        // socket.emit('test msg', player.name)
    }
    ...
    async askToPlayTurn() {
        ...
        console.log("payer to play:", nextColor)
